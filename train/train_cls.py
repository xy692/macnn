...
def solver_deploy(train_net_path, test_net_path=None, solver_path=None, base_lr=0.001):
    ...
    s.snapshot = 10000
    s.snapshot_prefix = '/home/xingyunyang/Documents/workspace/Multi-Attention-CNN/experiment/ft_bird_cls'
...
def main():
    niter = 10000
    base_lr = 0.01
    train_net_path = r'/home/xingyunyang/Documents/workspace/Multi-Attention-CNN/train/deploy/pig_cls_deploy_train.prototxt'
    ...
    weights_path = r'/home/xingyunyang/Documents/workspace/Multi-Attention-CNN/experiment/VGG19.caffemodel'
